...
class reporteArtProvee(View):
    def get(self, request, *args, **kwargs):
            ...
            context = {'titulo': 'esto es un pdf',}
            articulos = Articulo.objects.raw('SELECT a.ID AS ID, ep.NOMBRE, a.nombre AS articulos, o.FECHA_FIN, o.FECHA_INICIO, a.marca,a.modelo, o.PRECIO FROM OFERTA o, ARTICULO a, "EMPRESA PROVEEDORA" ep WHERE o.ID_ARTICULOS=a.ID AND o.ID_PROVEDORA=ep.ID')
            fechas = datetime.now()
